...
echo Downloading KF Linux...>resources\console.txt
...
echo Download complete. To use, open KindleSuite\kindlesuite\resources\kfl and extract the VM file, then open with VirtualMachine>resources\console.txt
exit